module Strip
  class StripsController < ApplicationController
    ...
    # GET /alert/leds/new
    def new
      redirect_to strips_url, notice: 'You are not authorized to do that.'
    end
    ...
    # POST /alert/leds
    def create
      @strip = ::Strip::Strip.new(strip_params)

      if @strip.save
        redirect_to strip_path(@strip), notice: 'Strip was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @strip.update(strip_params)
        redirect_to strip_path(@strip), notice: 'Strip was successfully updated.'
      else
        render :edit
      end
    end
